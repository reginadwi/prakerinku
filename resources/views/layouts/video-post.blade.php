...
<body>
                                    ...
                                    <li><a href="#">Mega</a>
                                        <div class="megamenu">
                                            ...
                                            <ul class="single-mega cn-col-4">
                                                <li><a href="/">Home</a></li>
                                                <li><a href="/archive">Archive</a></li>
                                                <li><a href="/ideo-post">Single Video Post</a></li>
                                                <li><a href="/single-post">Single Post</a></li>
                                                <li><a href="/about">About Us</a></li>
                                                <li><a href="/contact">Contact</a></li>
                                                <li><a href="/login">Login</a></li>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="{{('assets/frontend/background-image: url(img/bg-img/49.jpg)')}};">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <img class="mb-15" src="{{('assets/frontend/img/bg-img/51.jpg')}}" alt="">
                                </div>
                            </div>
                            ...
                            <div class="post-author d-flex align-items-center">
                                <div class="post-author-thumb">
                                    <img src="{{('assets/frontend/img/bg-img/52.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    ...
                                    <div class="post-content">
                                        <a href="/single-post" class="post-title">Dentists Are Smiling Over Painless Veneer</a>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    <div class="post-thumbnail">
                                        ...
                                        <a href=/"video-post" class="video-play"><i class="fa fa-play"></i></a>
                                        <span class="video-duration">09:27</span>
                                    </div>
                                    <div class="post-content">
                                        <a href="/single-post" class="post-title">Will The Democrats Be Able To Reverse</a>
                                        <div class="post-meta d-flex">
                                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 1034</a>
                                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 834</a>
                                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 234</a>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    ...
                                    <div class="post-content">
                                        <a href="/single-post" class="post-title">A Guide To Rocky Mountain Vacations</a>
                                        <div class="post-meta d-flex">
                                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 1034</a>
                                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 834</a>
                                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 234</a>
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="{{('assets/frontend/img/bg-img/53.jpg')}}" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="{{('assets/frontend/img/bg-img/54.jpg')}}" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <a href="#" class="comment-date">27 Aug 2019</a>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    <!-- Comment Author -->
                                    <div class="comment-author">
                                        <img src="{{('assets/frontend/img/bg-img/55.jpg')}}" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                    <div class="comment-meta">
                                        <a href="#" class="comment-date">27 Aug 2019</a>
                ...
                <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                    <div class="sidebar-area bg-white mb-30 box-shadow">
                        ...
                        <div class="single-sidebar-widget">
                            <a href="#" class="add-img"><img src="{{('assets/frontend/img/bg-img/add2.png" alt=""></a>
                        </div>
                        ...
                        <div class="single-sidebar-widget p-30">
                            ...
                            <div class="single-youtube-channel d-flex">
                                ...
                                <div class="youtube-channel-content">
                                    <a href="/single-post" class="channel-title">TV Show</a>
                            ...
                            <div class="single-youtube-channel d-flex">
                                ...
                                <div class="youtube-channel-content">
                                    <a href="/single-post" class="channel-title">Game Channel</a>
                                    <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                                </div>
                            </div>
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="{{('assets/frontend/img/bg-img/16.jpg')}}" alt="">
                                </div>
                                <div class="youtube-channel-content">
                                    <a href="/single-post" class="channel-title">Sport Channel</a>
                                    <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                                </div>
                            </div>
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="{{('assets/frontend/img/bg-img/17.jpg')}}" alt="">
                                </div>
                                <div class="youtube-channel-content">
                                    <a href="/single-post" class="channel-title">Travel Channel</a>
                                    <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                                </div>
                            </div>
                            ...
                            <div class="single-youtube-channel d-flex">
                                <div class="youtube-channel-thumbnail">
                                    <img src="{{('assets/frontend/img/bg-img/18.jpg')}}" alt="">
                                </div>
                                <div class="youtube-channel-content">
                                    <a href="/single-post" class="channel-title">LifeStyle Channel</a>
                                    <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                                </div>
                            </div>
