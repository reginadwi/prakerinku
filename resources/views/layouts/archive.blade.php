                ...
                <div class="col-12 col-xl-8">
                    <div class="archive-posts-area bg-white p-30 mb-30 box-shadow">
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/42.jpg)')}};">
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/43.jpg)')}};">
                                <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/44.jpg)')}};">
                                <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/45.jpg)')}};">
                                <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/46.jpg)')}};">
                                <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/47.jpg)')}};">
                                <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="{{('assets/frontend/background-image: url(img/bg-img/48.jpg)')}};">
                                <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            </div>
